...
import { Upload, Sparkles, BookmarkPlus, X, Library, Image as ImageIcon } from "lucide-react";
...
export function GenerationPanel({ onGenerate, isGenerating, onSavePrompt, activeFolder, prompts }: GenerationPanelProps) {
  ...
  // Split prompts into global (no folder) and project (with folder matching activeFolder)
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4 space-y-5">
        ...
        <div className="space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-6 rounded-lg border border-dashed border-input text-sm text-muted-foreground hover:border-primary hover:text-primary transition-colors"
          >
